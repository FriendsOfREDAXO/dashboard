...
if ('save_rss_config' === rex_request('ajax', 'string')) {
...
if ('load_rss_feed' === rex_request('ajax', 'string')) {
    header('Content-Type: application/json');
...
echo rex_view::title(Dashboard::getHeader() . $addon->i18n('title'));
echo '<div id="rex-dashboard">' . Dashboard::get() . '</div>';
